...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--epochs', type=int, default=15, help="rounds of training")#150
    ...
    parser.add_argument('--frac', type=float, default=0.1, help="the fraction of clients: C")#0.4
    ...
    parser.add_argument('--m_tr', type=int, default=250, help="maximum number of samples/user to use for training")
    parser.add_argument('--m_ft', type=int, default=250, help="maximum number of samples/user to use for fine-tuning")
    ...
    parser.add_argument('--local_rep_ep', type=int, default=12, help="the number of local epochs for the representation for FedRep")
    ...
    parser.add_argument('--round', type=int, default=3, help='train number of the per-task')#15
    parser.add_argument('--task', type=int, default=10, help='train number of task')
    parser.add_argument('--lamb', default=10000, type=float, help='(default=%(default)f)')
